...
7. Exporting the final trained model for inference usage
8. Integrating the final model into the Flask inference service
...
6. Spring Boot stores the prediction result in the H2 database
